...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-full p-1 text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col group-data-vertical/tabs:rounded-2xl data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted shadow-[inset_0_1px_3px_rgba(15,23,42,0.10)]",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        // bg-background == bg-muted in this theme, so the active chip uses secondary instead
        "data-active:bg-secondary data-active:text-secondary-foreground data-active:shadow-[0_2px_6px_rgba(15,23,42,0.16),0_1px_1px_rgba(15,23,42,0.10)]",
